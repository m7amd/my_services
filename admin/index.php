            ...
            <a href="../admin/pageone.php" target="_plank">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    هذه الخدمة تسمح للمستخدمين بتقديم إخطار رسمي للجهات
                    المعنية عن تغيير عنوان سكنهم، وذلك لضمان تحديث السجلات
                    والمعلومات الخاصة بهم.
                  </p>
                </div>
              </div>
            </a>
            ...
            <a href="../admin/pagetwo.php" target="_plank">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    يتيح هذا الخدمة للأفراد طلب شهادة تثبت عدم وجود سوابق
                    جنائية أو قانونية ضدهم، وهي غالبًا مطلوبة في العديد من
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    ولادتهم، وتعد هذه الشهادة أحد الوثائق الضرورية في العديد
                    من الإجراءات الرسمية والشخصية.
                  </p>
                </div>
              </div>
            </a>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    خارج البلاد وللقيام بالإجراءات الحكومية والإدارية اللازمة.
                  </p>
                </div>
              </div>
            </a>
